...
<body bgcolor="#100c08">
  ...
  <div id="container">
    <div id="nav-side">
	  ...
	  $db = new PDO('sqlite:/var/www/html/cart.db');
	  $item1 =$db->query("SELECT name FROM products WHERE pid=1");
	  $item2 =$db->query("SELECT name FROM products WHERE pid=2");
	  $item3 =$db->query("SELECT name FROM products WHERE pid=3");
	  $item4 =$db->query("SELECT name FROM products WHERE pid=4");
	  
	  $cat1;
	  $cat2;
	  $cat3;
	  $cat1 =$db->query("SELECT name FROM categories WHERE pid=1");
	  $cat1 =$db->query("SELECT name FROM categories WHERE pid=2");
	  $cat1 =$db->query("SELECT name FROM categories WHERE pid=3");
	  ?>
	  <div class="pro-kinds">
        <h1 class="kinds-tit">Product Kinds</h1>
        <div class="kinds-cont">
          <div class="kinds-det">
            <h2 class="det-tit"><?php echo $cat1; ?></h2>
            <div class="det-content">
              <a href="product/details.html"><?php echo $item1; ?></a>
              <a href="product/details.html"><?php echo $item1; ?></a>
			  <a href="product/details.html"><?php echo $item1; ?></a>
			  <a href="product/details.html"><?php echo $item1; ?></a>
			  <a href="product/details.html"><?php echo $item1; ?></a>
          ...
          <div class="kinds-det">
            <h2 class="det-tit">$cat2</h2>
            <div class="det-content">
              <a href="product/details.html"><?php echo $item2; ?></a>
              <a href="product/details.html"><?php echo $item2; ?></a>
			  <a href="product/details.html">$item2</a>
			  <a href="product/details.html">$item2</a>
			  <a href="product/details.html">$item2</a>
			  <a href="product/details.html">$item2</a>
			  <a href="product/details.html">$item2</a>
			...
			<div class="kinds-det">
            <h2 class="det-tit">$cat3</h2>
            <div class="det-content">
              <a href="product/details.html">$item3</a>
              <a href="product/details.html">$item3</a>
			   <a href="product/details.html">$item3</a>
			    <a href="product/details.html">$item3</a>
				 <a href="product/details.html">$item3</a>
